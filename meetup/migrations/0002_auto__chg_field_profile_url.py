...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.url'
        db.alter_column(u'meetup_profile', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Profile.url'
        db.alter_column(u'meetup_profile', 'url', self.gf('django.db.models.fields.URLField')(default='http://djangocph.dk', max_length=200))
